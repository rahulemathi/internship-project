            ...
            <div class="col-md-4 order-md-2 mb-4">
                ...
                <ul class="list-group mb-3">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                        ...
                        <span class="text-muted">&#8377;<?php echo $row['dprice'];?></span>
                    </li>
                    <?php 
                     }
                    }
                    ...
                    <li class="list-group-item d-flex justify-content-between">
                        <span>Total (INR)</span>
                        <strong>&#8377; <?php echo $_GET['dpp'];?></strong>
                    </li>
                </ul>
                ...
                <form action="checkoutstatus.php?checkout=success" class="needs-validation" novalidate>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" id="firstName" placeholder="" value="<?php echo $_SESSION['username'];?>" required>
                    ...
                    <hr class="mb-4">
                    <button class="btn btn-primary btn-lg btn-block" type="submit" name="checkout" value="checkout">Continue to checkout</button>
                </form>
            </div>
        </div>
    </div>
